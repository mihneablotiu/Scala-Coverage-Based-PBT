...
digraph composition {{
  ...
  subgraph cluster_flow {{
    ...
    fb   [label=<<b>Feedback</b><br/><font point-size="9">covered statements &middot; corpus &middot; seen inputs</font>>, shape=box, style="rounded,filled", fillcolor="#FCF3CF"];
    pool [label=<<b>Pool</b><br/><font point-size="9">reuse literals while<br/>branches are uncovered</font>>, shape=box, style="rounded,filled", fillcolor="{POOL}", fontcolor="white"];
